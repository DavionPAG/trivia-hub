...
const nextRound = async () => {
    ...
    // Hit API... get data
        ...
        // set answers & correct answer to proper spots in the 'answers' object within the 'trivia object
...
hub.on('player connected', payload => {
...
hub.on('answer submitted', payload => {
    ...
    if(payload === trivia.answers.correct) {
